...
def evaluar_vela_m5(df):
    """
    Condición 'Cero dudas': La vela arranca fuerte y limpia.
    ...
    if alcista or bajista:
        return 'VALIDA' # Señal limpia: Operación en silencio
    else:
        return 'SENAL_FALSA' # Falla en confluencia: Dispara alerta
        ...
        try:
            ...
            if minuto_actual % 5 == 1:
                for par in PARES_DIVISAS:
                    ...
                    resultado = 'SENAL_FALSA' # <-- FORZADO PARA PROBAR EL CORREO
